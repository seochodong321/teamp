      ...
      {tab === 'guide' && isLeader && (
        <div className={styles.section}>
          ...
          <div className={styles.guideCard}>
            ...
            <button className={styles.guideShortcut} onClick={() => setTab('milestone')}>마일스톤 탭으로 가기 →</button>
          </div>
          ...
          <div className={styles.guideCard}>
            ...
            <button className={styles.guideShortcut} onClick={() => setTab('todo')}>할 일 탭으로 가기 →</button>
          </div>
